...
using SchedulerApplication.Services.WeekConfigurator;
...
namespace SchedulerApp.Testing;
    ...
    public class WeeklyExecutionServiceTests
    {
        ...
        public void CalculateWeeklyDates_ShouldReturnCorrectNextDay(int year, int month, int day, DayOfWeek dayOfWeek, string expected)
        {
            // Arrange
        ...
        public void CalculateWeeklyDates_ShouldReturnCorrectDates()
        {
            ...
            // Act
            var result = service.CalculateWeeklyDates(initialDate, new List<DayOfWeek> { DayOfWeek.Monday, DayOfWeek.Wednesday }, 1);
